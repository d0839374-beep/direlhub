...
function UILibrary:CreateWindow(config)
	...
	local closeBtn = createControlButton("Close", "✕", -90, Color3.fromRGB(255, 120, 120))
	...
	function windowData:AddTab(tabConfig)
		...
		function tab:AddButton(btnConfig)
			...
			local btn = create("TextButton", {
				Name = "Button_" .. text,
				Size = UDim2.new(1, 0, 0, 40),
				Position = UDim2.new(0, 0, 0, getNextY()),
			...
			local btnCorner = create("UICorner", { CornerRadius = UDim.new(0, 8), Parent = btn })
			local btnStroke = create("UIStroke", { Thickness = 1, Color = Color3.fromRGB(140, 0, 255), Transparency = 0.5, Parent = btn })
		...
		function tab:AddToggle(togConfig)
			...
			local bgCorner = create("UICorner", { CornerRadius = UDim.new(1, 0), Parent = toggleBg })
			...
			local circCorner = create("UICorner", { CornerRadius = UDim.new(1, 0), Parent = circle })
		...
		function tab:AddSlider(sliderConfig)
			...
			local bgCorner = create("UICorner", { CornerRadius = UDim.new(1, 0), Parent = sliderBg })
			...
			local fillCorner = create("UICorner", { CornerRadius = UDim.new(1, 0), Parent = fill })
		...
		function tab:AddDropdown(dropConfig)
			...
			local btnCorner = create("UICorner", { CornerRadius = UDim.new(0, 8), Parent = dropBtn })
			...
			dropBtn.MouseButton1Click:Connect(function()
				...
				local listCorner = create("UICorner", { CornerRadius = UDim.new(0, 8), Parent = listFrame })
				local listStroke = create("UIStroke", { Thickness = 1, Color = Color3.fromRGB(140, 0, 255), Transparency = 0.5, Parent = listFrame })
				...
				for _, opt in ipairs(options) do
					...
					local optCorner = create("UICorner", { CornerRadius = UDim.new(0, 4), Parent = optBtn })
		...
		function tab:AddInput(inputConfig)
			...
			local boxCorner = create("UICorner", { CornerRadius = UDim.new(0, 8), Parent = box })
			local boxStroke = create("UIStroke", { Thickness = 1, Color = Color3.fromRGB(140, 0, 255), Transparency = 0.5, Parent = box })
	...
	function windowData:Notify(config)
		...
		local notifCorner = create("UICorner", { CornerRadius = UDim.new(0, 12), Parent = notif })
		local notifStroke = create("UIStroke", { Thickness = 1.5, Color = Color3.fromRGB(140, 0, 255), Transparency = 0.5, Parent = notif })
		addGradient(notif, {
